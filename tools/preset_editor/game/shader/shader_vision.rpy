...
init python:
    ...
    """, fragment_300="""
        ...
        // Animated noise
        float animNoise(vec2 p, float t) {
            return noise(p + vec2(sin(t), cos(t)) * 10.0);
        }
        ...
        void main() {
            ...
            float n1 = noise(noiseUV * 50.0);
            float n2 = noise(noiseUV * 100.0 + 50.0);
            float n3 = noise(noiseUV * 25.0 + 100.0);
    ...
    """, fragment_300="""
        ...
        void main() {
            ...
            // Add sensor noise
            float noise = (hash(v_tex_coord * u_model_size) - 0.5) * u_noise_intensity;
    ...
    """, fragment_300="""
        ...
        void main() {
            ...
            // Add noise
            float n = noise(uv * 100.0 + u_time * 10.0);
