...
class DemoGenerator:
    ...
    def generate_script(self) -> str:
        ...
        lines = [
            ...
            f"## Mode: {'Dialog/Text Shader Testing' if self.apply_to_dialog else 'Character/Image Testing'}",
            "",
        ]
        ...
        for i, item in enumerate(self.items):
            ...
            if self.apply_to_dialog:
                # Dialog/Text Shader Testing Mode
                # - Shaders applied to say screen window via demo_dialog_transform
                # - Text shaders applied via {shader=...} tags in dialogue
                # This matches how a real game would style dialog boxes
                ...
                # The say screen applies demo_dialog_transform to the window
                ...
                # This matches how a real game would animate characters
